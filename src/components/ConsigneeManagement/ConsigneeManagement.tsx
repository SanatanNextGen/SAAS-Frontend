...
const ConsigneeManagement = () => {
  ...
  const handleSubmit = async (formData: any) => {
    ...
    if (selectedData && selectedData._id) {
      // Update an existing consignee - ensure we're using the _id from selectedData
      try {
        const updatedData = {
          ...formData,
        ...
        const updated = await updateConsignee(selectedData._id, updatedData);
        ...
        alert("Error updating consignee. Please try again.");
      }
    } else {
      ...
      try {
        ...
        alert("Error creating consignee. Please try again.");
      }
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    if (success) {
      setData((prev) => prev.filter((consignee) => consignee._id !== id));
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
          ...
          >
            ...
            >
              ...
              <p className="mb-6 text-gray-600">
                Are you sure you want to delete this consignee? This action
                cannot be undone.
              </p>
      ...
      >
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
          <div>
            ...
            >
              Manage all your consignees in one place
            </motion.p>
          </div>
      ...
      >
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search consignees by name, email, phone or GSTIN..."
            value={searchTerm}
                  ...
                  <tr>
                    ...
                    >
                      <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                      >
                        <p className="text-lg">No consignees found</p>
                        <p className="mt-2 text-sm">
                          Try adjusting your search or add a new consignee
                        </p>
                      </motion.div>
                    </td>
                  </tr>
