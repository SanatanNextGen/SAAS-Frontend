...
const BranchManagement = () => {
  ...
  const handleSubmit = async (formData: any) => {
    ...
    if (selectedData && selectedData._id) {
      // Update an existing branch - ensure we're using the _id from selectedData
      try {
        const updatedData = {
          ...formData,
        ...
        const updated = await updateBranches(selectedData._id, updatedData);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
      ...
      >
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
          <div>
            ...
            >
              Manage all your branchs in one place
            </motion.p>
          </div>
      ...
      >
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search branchs by name, email, phone or GSTIN..."
            value={searchTerm}
                  ...
                  <tr>
                    ...
                    >
                      <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                      >
                        <p className="text-lg">No branchs found</p>
